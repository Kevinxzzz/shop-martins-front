...
const SLIDES: BannerSlide[] = [
  { src: '/banner-martins.png', alt: 'Martins Vendas — Marketplace Esportivo Premium' },
  { src: '/banner-martins2.png', alt: 'Martins Vendas — Ofertas Esportivas' },
];
...
export default function HomeBannerCarousel() {
  ...
  return (
    <section className={styles.carousel} aria-roledescription="carousel" aria-label="Banners promocionais">
